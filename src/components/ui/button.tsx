...
const button = cva(
  'inline-flex cursor-pointer items-center justify-center gap-2 font-semibold rounded-sm transition-colors focus-visible:outline-none focus-visible:shadow-focus disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
        primary:
